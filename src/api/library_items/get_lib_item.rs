...
//
//
///// Get a Library Item (allow in particular to retrieve all podcast episode id)
...
//
//
//pub async fn get_lib_item(token: &str, id) -> Result<Root> {
//    let client = Client::new();
//    let url = "https://audiobook.nuagemagique.duckdns.org/api/items/{}";
//
//    // json bosy
//    let body = json!({
