...
`bug_id: 9bacac` 
**Sync**: If you open VLC and listening X, close VLC and and quickly open VLC to listen Y: X will still be sync according to Y (normally, only Y has to be sync in this case).
